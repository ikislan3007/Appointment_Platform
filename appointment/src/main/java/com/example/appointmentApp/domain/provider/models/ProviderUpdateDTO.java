...
public record ProviderUpdateDTO(@NotNull(message = "Name cannot be null")
                                ...
                                @Pattern(regexp = "^[A-Za-z]*$", message = "Domain must be written without a dot,use only letters")
                                String domain,
